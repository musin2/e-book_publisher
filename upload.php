...
<form action="uploadaction.php" method="post" enctype="multipart/form-data">
  <div class="form-row">
     <div class="col">       <!--input-group row mb-3 form group align-items-center col-7-->
      ...
      <input type="text" class="form-control" id="username1" name="username" aria-describedby="username1" required>
    ...
    <div class="form-group mt-2">    <!--col-7 space-top input-group-->
        <label for="b_file" class="mr-2 form-label">Book file(.pdf)</label>  <!--form-label-->
        <input class="form-control " type="file" id="b_file" name="b_file"required>
      </div>

      <div class="form-group mt-2">
        <label for="b_cover" class="mr-2 form-label">Book cover image(.png/jpeg/jpg)</label>
        <input class="form-control" type="file" id="b_cover" name="b_cover" required>
      </div>
